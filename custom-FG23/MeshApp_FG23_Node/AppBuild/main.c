...
*****************************************************************************/
//[Kimbal]
extern void k_start_test_app(void);
extern void k_init_test_app(void);
extern void k_init_meter_comm(void);
extern void k_init_info_plus_meter_comm(void);
...
//#define    INFO_PLUS_METER_TEST

extern void SET_NETWORK_STATE_HIGH();
...
int main(void)
{
  ...
  counter++;
  //counter=0;
  nvm3_writeData(NVM3_DEFAULT_HANDLE_1,key_1,&counter,1);
 ...
 // SET_NETWORK_STATE_HIGH();
  ...
  k_init_test_app();
  k_start_test_app();
#elif defined(METER_TEST)
  k_init_meter_comm();
#elif defined(INFO_PLUS_METER_TEST)
  k_init_info_plus_meter_comm();  
#else
#endif
 ...
 // timer_2_init();
  ...
  while (1) {
    ...
    // Application process.
    join_state = get_current_join_state();
...
#define MAC_ADDRESS_OF_DEV_0	 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x09


#define MAC_ADDRESS_OF_DEV_1	 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x19


#define MAC_ADDRESS_OF_DEV_2	 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x20
